...
with col2:
    st.image("/Users/jjacton/Desktop/Python/Streamlit_dashboard/images/Profile_picture.png", width=350)
...
st.markdown("""
            ...
            """, unsafe_allow_html=True)
st.subheader("")
with open("/Users/jjacton/Desktop/Python/Streamlit_dashboard/images/JJ_Acton_Thesis.pdf", "rb") as file:
        st.download_button(
