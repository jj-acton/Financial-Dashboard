...
col2.image("/Users/jjacton/Desktop/Python/Streamlit_dashboard/images/Core Principles of XGBoost - visual selection.svg", width=800)
...
with tab1:
    st.image("/Users/jjacton/Desktop/Python/Streamlit_dashboard/images/How Supervised Machine Learning Works - visual selection.svg", caption="How Supervised Machine Learning Works", use_container_width=True)
with tab2:
    st.image("/Users/jjacton/Desktop/Python/Streamlit_dashboard/images/Decision Trees in Machine Learning_ A Comprehensive Guide - visual selection.svg", caption="Decision Trees", use_container_width=True)
with tab3:
    st.image("/Users/jjacton/Desktop/Python/Streamlit_dashboard/images/Ensemble Learning_ A Comprehensive Overview - visual selection.svg", caption="Ensemble Learning", use_container_width=True)
with tab4:
    st.image("/Users/jjacton/Desktop/Python/Streamlit_dashboard/images/Core Principles of Gradient Boosting - visual selection.svg", caption="Gradient Boosting", use_container_width=True)
st.write("---")
